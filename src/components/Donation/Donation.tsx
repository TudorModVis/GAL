...
const Donation = () => {
  ...
  return (
    <section className="w-screen h-fit grid grid-cols-donation relative px-8 mt-24 pb-24">
      <div className="order-2 sm:order-1 col-span-full sm:col-span-11 sm:grid sm:grid-cols-11 text-sand-50 bg-forest-800 sm:p-8 p-6 sm:rounded-l-2xl rounded-b-2xl">
        <AnimatedHeader
      ...
      <div className="order-1 sm:order-2 col-span-full sm:col-span-13 sm:h-auto h-48 bg-black relative sm:rounded-r-2xl rounded-t-2xl overflow-hidden">
        <Image
