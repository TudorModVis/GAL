    ...
    >
      <div className="grid grid-cols-full auto-rows-min w-full">
        ...
        <div className="flex flex-col gap-2 sm:col-start-4 col-span-full sm:col-span-2 sm:row-start-2 sm:mt-24">
          ...
          <Link href="/news">
            <AnimatedLink
              text={tFooter("useful_information.announcements_link")}
            />
          </Link>
          <Link href="/">
          ...
          <Link href="/">
            <AnimatedLink
              text={tFooter("useful_information.authentic_local")}
            />
          </Link>
        </div>
      ...
      <div className="grid grid-cols-full auto-rows-min w-full">
        ...
        <div className="mt-[4vh] flex justify-between flex-col sm:flex-row items-baseline col-span-full">
          <h4>{tFooter("useful_information.copyright")}</h4>
          <Socials />
          <div className="flex gap-8">
            <Link href="/">
              {tFooter("useful_information.terms_and_conditions")}
            </Link>
            <Link
