		...
		<>
			...
			<div className='col-span-full flex sm:items-center my-4'>
				<input
					...
					id='confirmation'
					name='confirmation'
					className='mr-2 w-3 h-3 shrink-0 sm:mt-0 mt-1 appearance-none border-sand-50 cursor-pointer checked:bg-[url("/checkmark.svg")] transition border-[1px] rounded-xs checked:bg-center checked:bg-no-repeat '
				/>
				<label
					className='text-xs'
