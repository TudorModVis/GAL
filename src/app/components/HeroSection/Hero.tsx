...
export default function Hero({ heroTitle1, heroTitle2 }: HeroProps) {
  ...
  return (
    <section className="w-screen h-screen grid grid-cols-full relative px-8">
      <video
      ...
      <motion.div
        className="relative overflow-hidden font-bold text-sand-50 text-[5rem] leading-24 col-start-3 self-center text-center col-span-8 mx-auto"
      >
        <h1>
