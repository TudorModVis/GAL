...
const NavBar = () => {
  ...
  return (
    <>
      <nav>
        <div className="grid grid-cols-full items-center transition transparent left-1/2 -translate-x-1/2 text-sand-50 absolute w-full m-auto z-10 px-8 py-4">
        ...
        <motion.div
          ...
          className={`hidden ${
            isInitialLoad ? "" : "!grid text-forest-900 bg-sand-50"
          } left-1/2 -translate-x-1/2 grid-cols-full -top-64 items-center transition max-w-[1512px] justify-between fixed w-full m-auto z-10 px-8 py-4`}
        >
