...
const LanguageSwitcher: React.FC<ArrowColor> = ({ arrowColor }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute group-hover:opacity-100 opacity-0 transition ${
          arrowColor === "#11200B"
            ? "text-sand-50 bg-forest-900"
            : "text-forest-900 bg-sand-50"
        } px-2 py-0.5 left-1/2 -translate-x-1/2 rounded-xs min-w-[42px] z-10`}
      >
        <button
