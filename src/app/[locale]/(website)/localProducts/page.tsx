  ...
  return (
    <>
      <main className="relative w-full h-fit mb-[100vh] bg-sand-50">
        <InfoSection
          tags={["Produse Locale"]}
          headerText="Descoperă gustul autentic al regiunii noastre prin produsele locale create cu grijă și tradiție."
          lastActualization="23.03.2025"
          location={["Acasă", "Autentic Local", "Produse Locale"]}
