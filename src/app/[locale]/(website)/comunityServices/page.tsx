  ...
  return (
    <>
      <main className="relative w-full h-fit mb-[100vh] bg-sand-50">
        <InfoSection
          tags={["Servicii din Comunitate"]}
          headerText="Alege servicii oferite de oameni pasionați, meșteșugari și profesioniști locali."
          lastActualization="23.03.2025"
          location={["Acasă", "Autentic Local", "Servicii din Comunitate"]}
