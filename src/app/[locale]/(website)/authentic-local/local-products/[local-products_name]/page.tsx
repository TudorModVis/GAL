...
export async function generateMetadata({
	...
	params: Promise<{ locale: Locale; 'local-products_name': string }>
}) {
	const { locale, ['local-products_name']: localProductsName } = await params
	...
	try {
		const res = await blogService.getBlogById(localProductsName)
