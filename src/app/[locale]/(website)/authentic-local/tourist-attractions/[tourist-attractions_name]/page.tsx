...
export async function generateMetadata({
	...
	params: Promise<{ locale: Locale; 'tourist-attractions_name': string }>
}) {
	const { locale, ['tourist-attractions_name']: touristAttractionsName } = await params
	...
	try {
		const res = await blogService.getBlogById(touristAttractionsName)
